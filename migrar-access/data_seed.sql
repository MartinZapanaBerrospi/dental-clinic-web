...
-- Table: appointments
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6961, 1544, '2025-10-13 16:00:00', 'Attended', 'se le ofrecio el sabado 18 pero l adra no puede asistir') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6962, 1544, '2025-10-18 11:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6963, 1544, NULL, 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6974, 1545, '2025-10-16 15:00:00', 'Scheduled', 'se le escribe 17/01/26') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6975, 1546, '2025-10-18 11:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6977, 1547, '2025-10-22 17:30:00', 'Scheduled', 'evaluara la proforma con su esposo') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6982, 1548, '2025-10-22 18:00:00', 'Attended', 'posiblemnte para el 5 de noviembre, revisara proforma escrita que la dra le dio') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6984, 1544, '2025-10-24 8:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6985, 1549, '2025-10-23 14:00:00', 'Attended', 'consultara con su esposo por la proforma, puede en las mañanas (debido a la sedacion)/ se le escribe 17/01/26') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6986, 1550, '2025-10-23 14:00:00', 'Attended', 'consultara con su esposo por la proforma, puede en las mañanas (debido a la sedacion)') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6987, 1551, '2025-10-23 18:10:00', 'Attended', 'para fluor, que termine de salir las muelitas') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6988, 1551, '2025-12-18 00:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (6990, 1544, '2025-10-27 8:00:00', 'Attended', 'terminos sedacion, curaciones, limpieza, fluor barnis') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7008, 1552, '2025-11-04 19:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7010, 1553, '2025-11-06 18:00:00', 'Attended', 'para cambio de amalgamas se le dijo 150 c/u y curaciones desde 60 soles') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7032, 1554, '2025-11-13 11:00:00', 'Attended', 'vera sus horarios/ se le escribio 20/01/26') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7036, 1555, '2025-11-18 18:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7044, 1556, '2025-11-22 16:30:00', 'Attended', 'se comunicara para las curaciones pendientes') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7064, 1557, '2025-11-27 17:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7065, 1557, '2025-12-02 17:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7068, 1558, '2025-11-27 19:15:00', 'Attended', 'en mayo 2026') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7070, 1559, '2025-11-29 14:30:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7073, 1560, '2025-12-02 15:00:00', 'Attended', 'se le escribio 29/01/26') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7074, 1557, '2025-12-04 14:00:00', 'No Show', 'estaba reesfriada, pidio reprogramar') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7088, 1561, '2025-12-12 16:00:00', 'Attended', 'para extraccion de tercera molar, curaciones, limpieza') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7107, 1559, '2025-12-22 11:00:00', 'No Show', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7111, 1559, '2025-12-23 10:30:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7113, 1562, '2025-12-27 10:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7146, 1563, '2026-01-20 10:00:00', 'Attended', 'para endodoncia, se le nevio rx al dr quispe y el dr debe confirmar horario disponible, quispe disponible lunes tarde.') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7150, 1564, '2026-01-20 19:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7151, 1564, '2026-01-24 16:30:00', 'Cancelled', 'fluor barniz falta') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7181, 1565, '2026-01-30 18:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7183, 1565, '2026-02-06 17:30:00', 'Scheduled', 'para extraccion de terceras molares') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7186, 1566, '2026-02-04 17:00:00', 'Attended', 'para curacines rstantes') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7194, 1567, '2026-02-10 14:00:00', 'No Show', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7210, 1568, '2026-02-13 18:17:00', 'Attended', 'LUEGO DE TOMARSE PANORAMICA Y QUE SU HIJA TERMINE EEELLA EMPEZARA ORTODONCIA') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7212, 1569, '2026-02-18 19:00:00', 'Attended', 'luego de primera cita') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7213, 1570, '2026-02-19 17:00:00', 'No Show', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7214, 1571, '2026-02-18 16:00:00', 'No Show', 'no asistio a primera cita') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7218, 1569, '2026-02-25 19:00:00', 'Scheduled', 'PIDIO REPROGRAMAR, mama no podria traerlo a la cita, luego papa no responde') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7222, 1557, '2026-02-19 15:44:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7227, 1568, '2026-02-20 18:45:00', 'Scheduled', 'no se atendio por falta de hora, sera para la semana del 23 de febrero/ ortodoncia/ ya tiene su panoramica') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7235, 1570, '2026-02-21 14:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7238, 1557, '2026-02-21 10:30:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7241, 1572, '2026-02-24 15:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7242, 1572, '2026-02-27 16:00:00', 'No Show', '(Hijo de Eva Quispe)solo no llego, no habia confirmado para ver lo de su ortodoncia, ya enviaron su panoramica') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7261, 1570, '2026-03-03 17:00:00', 'Attended', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7262, 1570, '2026-03-13 18:00:00', 'Scheduled', 'para evalaucion ortodoncia') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7264, 1573, '2026-03-04 16:30:00', 'No Show', 'de provincia, solo queria curacion que se le salio a su hija') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7266, 1574, '2026-03-04 19:30:00', 'Scheduled', 'no vino a primera cita, citar viernes o miercoles') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7284, 1557, '2026-03-19 11:00:00', 'Attended', 'vino esta vez por que se le salio la ultima curacion que se le hizo, no se le cobro') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7287, 1575, '2026-03-19 10:00:00', 'Attended', 'curaciones, restos, ortodoncia') ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7288, 1576, '2026-03-19 15:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7297, 1572, '2026-03-21 17:00:00', 'Scheduled', NULL) ON CONFLICT DO NOTHING;
INSERT INTO appointments (id, patient_id, scheduled_start, status, notes) VALUES (7300, 1577, '2026-03-23 11:00:00', 'Scheduled', 'esperando su radigorafi panoramica') ON CONFLICT DO NOTHING;
